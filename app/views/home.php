...
<body>
    <!-- Navigation Bar -->
    <nav class="bg-white bg-opacity-30 p-2 fixed top-0 left-0 w-full z-10">
        ...
        <img src="/ecommerce/public/images/12345.png" alt="weftf" class="w-full max-w-full h-auto object-contain">
        <img src="/ecommerce/public/images/16.jpg " alt="weftf" class="w-full max-w-full h-auto object-contain"> 
        <img src="/ecommerce/public/images/1234.png" alt="weftf" class="w-full max-w-full h-auto object-contain"> 
        <img src="/ecommerce/public/images/123.jpeg " alt="weftf" class="w-full max-w-full h-auto object-contain"> 
